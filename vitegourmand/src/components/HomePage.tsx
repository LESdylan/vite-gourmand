...
export default function HomePage({ setCurrentPage }: HomePageProps) {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Old Hero Section Removed - Using new HeroSection component */}
      <section 
        className="relative h-0 bg-cover bg-center hidden"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://images.unsplash.com/photo-1751651054934-3fbdf1d54d8b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYXRlcmluZyUyMGVsZWdhbnQlMjBmb29kfGVufDF8fHx8MTc3MDExMzI3Nnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral')`
        }}
      >
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl px-4">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Vite & Gourmand</h1>
            <p className="text-xl md:text-2xl mb-8">
              Votre traiteur de confiance à Bordeaux depuis 25 ans
            </p>
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Julie et José mettent leur savoir-faire au service de vos événements pour créer des moments inoubliables autour d'une cuisine raffinée et généreuse.
            </p>
            <Button
