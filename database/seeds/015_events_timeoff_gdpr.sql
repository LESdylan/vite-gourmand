...
INSERT INTO public.delivery_assignments (id, order_id, driver_id, status, assigned_at, picked_up_at, delivered_at, delivery_rating, delivery_notes) VALUES
  ...
  ('da000000-0000-0000-0000-000000000004', 'or000000-0000-0000-0000-000000000007', 'a0000000-0000-0000-0000-000000000005', 'delivered', '2026-04-25 11:00:00+00', '2026-04-25 11:30:00+00', '2026-04-25 13:00:00+00', 5, 'Client très satisfait'),
  ('da000000-0000-0000-0000-000000000005', 'or000000-0000-0000-0000-000000000012', 'a0000000-0000-0000-0000-000000000005', 'in_transit', '2026-05-01 09:00:00+00', '2026-05-01 10:00:00+00', NULL, NULL, NULL)
...
INSERT INTO public.events (id, title, description, start_date, end_date, all_day, event_type, user_id, order_id, created_by) VALUES
  ...
  ('ev000000-0000-0000-0000-000000000001', 'Mariage Dupont – 50 pers.', 'Livraison menu prestige', '2026-01-15 10:00', '2026-01-15 14:00', false, 'order', 'a0000000-0000-0000-0000-000000000007', 'or000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000002'),
  ('ev000000-0000-0000-0000-000000000002', 'Cocktail Entreprise Martin', 'Cocktail dînatoire 20 pers.', '2026-02-01 17:00', '2026-02-01 21:00', false, 'order', 'a0000000-0000-0000-0000-000000000008', 'or000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000002'),
  ('ev000000-0000-0000-0000-000000000003', 'Saint-Valentin Bernard', 'Dîner romantique 2 pers.', '2026-02-14 19:00', '2026-02-14 22:00', false, 'order', 'a0000000-0000-0000-0000-000000000009', 'or000000-0000-0000-0000-000000000003', 'a0000000-0000-0000-0000-000000000003'),
  ('ev000000-0000-0000-0000-000000000004', 'Anniversaire Petit', 'Buffet anniversaire 15 pers.', '2026-03-01 11:00', '2026-03-01 16:00', false, 'order', 'a0000000-0000-0000-0000-000000000010', 'or000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000003'),
  ('ev000000-0000-0000-0000-000000000005', 'Livraison Moreau', 'Menu terroir 10 pers.', '2026-03-25 18:00', '2026-03-25 21:00', false, 'order', 'a0000000-0000-0000-0000-000000000011', 'or000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000002'),
  -- Company events
  ('ev000000-0000-0000-0000-000000000006', 'Réunion d''équipe', 'Point hebdomadaire sur les commandes', '2026-05-05 09:00', '2026-05-05 10:00', false, 'meeting', NULL, NULL, 'a0000000-0000-0000-0000-000000000002'),
  ('ev000000-0000-0000-0000-000000000007', 'Formation hygiène HACCP', 'Formation obligatoire annuelle', '2026-05-12 09:00', '2026-05-12 17:00', true, 'training', NULL, NULL, 'a0000000-0000-0000-0000-000000000002'),
  ('ev000000-0000-0000-0000-000000000008', 'Inventaire mensuel', 'Inventaire stock cuisine', '2026-05-31 08:00', '2026-05-31 12:00', false, 'task', NULL, NULL, 'a0000000-0000-0000-0000-000000000004'),
  ('ev000000-0000-0000-0000-000000000009', 'Fermeture annuelle', 'Congés d''été', '2026-08-01 00:00', '2026-08-15 23:59', true, 'holiday', NULL, NULL, 'a0000000-0000-0000-0000-000000000002'),
  ('ev000000-0000-0000-0000-00000000000a', 'Salon du Mariage', 'Stand Vite & Gourmand', '2026-09-15 09:00', '2026-09-17 18:00', true, 'external', NULL, NULL, 'a0000000-0000-0000-0000-000000000002'),
  -- Upcoming order events
  ('ev000000-0000-0000-0000-00000000000b', 'Livraison prép. commande #8', 'Menu halal 10 pers. Toulouse', '2026-05-10 16:00', '2026-05-10 20:00', false, 'order', 'a0000000-0000-0000-0000-000000000013', 'or000000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000004'),
  ('ev000000-0000-0000-0000-00000000000c', 'Livraison anniversaire #11', 'Baptême 15 pers. Lyon', '2026-06-01 11:00', '2026-06-01 14:00', false, 'order', 'a0000000-0000-0000-0000-000000000009', 'or000000-0000-0000-0000-00000000000b', 'a0000000-0000-0000-0000-000000000003')
ON CONFLICT (id) DO NOTHING;
...
INSERT INTO public.user_consents (id, user_id, consent_type, consented, ip_address) VALUES
  ...
  ('uc000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000008', 'newsletter',        true,  '90.120.5.78'),
  ('uc000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000009', 'cookies_analytics', false, '176.30.8.12'),
  ('uc000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000010', 'cookies_analytics', true,  '81.65.200.3')
ON CONFLICT (id) DO NOTHING;
